...
export const AdminMagicLinkEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Admin Access - Magic Link Login</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Admin Access</Heading>
        <Text style={text}>
          You requested admin access to the Alteryx New Hire Store management system.
        </Text>
        <Link
        ...
        <Text style={{ ...text, marginBottom: '14px' }}>
          Or, copy and paste this temporary admin login code:
        </Text>
