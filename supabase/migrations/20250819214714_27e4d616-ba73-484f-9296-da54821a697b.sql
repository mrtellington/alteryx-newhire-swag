-- First, let's fix the users table constraint and update the function

-- Fix the users table to have a proper UUID default
ALTER TABLE public.users ALTER COLUMN id SET DEFAULT gen_random_uuid();

-- Update the create_user_from_webhook function to handle proper user creation
...
BEGIN
  ...
  -- Create new user in public.users table with UUID generation
  BEGIN
