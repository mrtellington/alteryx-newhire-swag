-- Remove tod.ellington@gmail.com exception from validate_email_domain function
...
BEGIN
  ...
  -- Check if valid (removed tod.ellington@gmail.com exception)
  is_valid := domain_part IN ('alteryx.com', 'whitestonebranding.com');
...
-- Remove tod.ellington@gmail.com exception from create_user_from_webhook function
...
BEGIN
  ...
  -- Validate email domain (removed tod.ellington@gmail.com exception)
  ...
  BEGIN
    ...
    IF FOUND THEN
      ...
      SET 
        ...
        shipping_address = COALESCE(user_shipping_address, public.users.shipping_address),
